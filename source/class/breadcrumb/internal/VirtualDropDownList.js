qx.Class.define("breadcrumb.internal.VirtualDropDownList", {
            ...
            switch (id) {
                case "list":
                    control = new qx.ui.list.List().set({
                        ...
                        height: null,
                        width: null,
                        maxHeight: (this._target.getMaxListHeight ? this._target.getMaxListHeight() : 300),
...
//        },
        ...
        __adjustHeight: function () {
            ...
            var maxListHeight = (this._target.getMaxListHeight ? this._target.getMaxListHeight() : 300);
